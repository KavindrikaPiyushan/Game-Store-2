...
import { uploadGame, getAllGames, deleteGame, updateGame ,addRatingPoints ,getSpecificGame,GamesShop,fetchGameById ,getGamesByDeveloper ,getGameNameByAssignedGameId} from '../controllers/gameController.js';
...
gameRouter.get('/getGamesByDeveloper/:developerId',getGamesByDeveloper);


//new route 
gameRouter.get('/fetchGame/:id', fetchGameById);
